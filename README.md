...
- `ComfyUI/models/ella_encoder`, create it if not present.
  - Place [t5 encoder model](https://huggingface.co/QQGYLab/ELLA/tree/main/models--google--flan-t5-xl--text_encoder) here, it should be a folder of transfomers structure with config.json
...
# Only need the text_encoder part here, https://huggingface.co/QQGYLab/ELLA/tree/main/models--google--flan-t5-xl--text_encoder
